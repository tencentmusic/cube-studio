...
# Hub
HUB_ENDPOINT = os.environ.get("HUB_ENDPOINT", "http://127.0.0.1")
ADD_DATASETS_URL = HUB_ENDPOINT + "/dataset_modelview/api/"
EDIT_DATASETS_URL = HUB_ENDPOINT + "/dataset_modelview/api/"
LIST_DATASETS_URL = HUB_ENDPOINT + "/dataset_modelview/api/"
UPLOAD_DATASETS_URL = HUB_ENDPOINT + "/dataset_modelview/api/"

...
app_names=["app1", "animegan", "stable-diffusion", "paddleocr", "gfpgan", "paddlespeech-asr", "humanseg", "paddlespeech-cls", "ddddocr", "paddlespeech-tts", "yolov3", "deoldify", "panoptic"]

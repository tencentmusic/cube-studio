...
docker build -t ccr.ccs.tencentyun.com/cube-studio/aihub:chatgpt ./chatgpt/ && docker push ccr.ccs.tencentyun.com/cube-studio/aihub:chatgpt &
docker build -t ccr.ccs.tencentyun.com/cube-studio/aihub:speaker-diarization ./speaker-diarization/ && docker push ccr.ccs.tencentyun.com/cube-studio/aihub:speaker-diarization &
docker build -t ccr.ccs.tencentyun.com/cube-studio/aihub:voxlingua107-ecapa ./voxlingua107-ecapa/ && docker push ccr.ccs.tencentyun.com/cube-studio/aihub:voxlingua107-ecapa &

...
class CV_IR_FACE_RECOGNITION_OOD_RTS_Model(Model):
    # 模型基础信息定义
    name='cv-ir-face-recognition-ood-rts'   # 该名称与目录名必须一样，小写
    label='人脸识别OOD模型'
    describe=""
    ...
    hot = "404"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_ir_face-recognition-ood_rts/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-recognition', 'damo/cv_ir_face-recognition-ood_rts')
...
model=CV_IR_FACE_RECOGNITION_OOD_RTS_Model()

...
class CV_UNET_PERSON_IMAGE_CARTOON_SKETCH_COMPOUND_MODELS_Model(Model):
    # 模型基础信息定义
    name='cv-unet-person-image-cartoon-sketch-compound-models'   # 该名称与目录名必须一样，小写
    ...
    doc = "https://modelscope.cn/models/damo/cv_unet_person-image-cartoon-sketch_compound-models/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('image-portrait-stylization', 'damo/cv_unet_person-image-cartoon-sketch_compound-models')
...
model=CV_UNET_PERSON_IMAGE_CARTOON_SKETCH_COMPOUND_MODELS_Model()

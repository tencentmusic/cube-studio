...
class SPEECH_SAMBERT_HIFIGAN_TTS_XIAODA_WUUSHANGHAI_16K_Model(Model):
    # 模型基础信息定义
    name='speech-sambert-hifigan-tts-xiaoda-wuushanghai-16k'   # 该名称与目录名必须一样，小写
    ...
    hot = "985"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/speech_tts/speech_sambert-hifigan_tts_xiaoda_WuuShanghai_16k/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-to-speech', 'speech_tts/speech_sambert-hifigan_tts_xiaoda_WuuShanghai_16k')
...
model=SPEECH_SAMBERT_HIFIGAN_TTS_XIAODA_WUUSHANGHAI_16K_Model()

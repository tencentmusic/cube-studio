    ...
    web_examples=[
        {
            "label": "示例1",
            "input": {
                "arg0": "/mnt/workspace/.cache/modelscope/damo/cv_tinynas_object-detection_damoyolo_safety-helmet/assets/demo/part2_002012.jpg"
            }
        },
        {
            "label": "示例2",
            "input": {
                "arg0": "/mnt/workspace/.cache/modelscope/damo/cv_tinynas_object-detection_damoyolo_safety-helmet/assets/demo/PartB_00579.jpg"
            }
        },
        {
            "label": "示例3",
            "input": {
                "arg0": "/mnt/workspace/.cache/modelscope/damo/cv_tinynas_object-detection_damoyolo_safety-helmet/assets/demo/000505.jpg"
            }
        }
    ]
...
result = model.inference(arg0='/mnt/workspace/.cache/modelscope/damo/cv_tinynas_object-detection_damoyolo_safety-helmet/assets/demo/part2_002012.jpg')  # 测试
print(result)

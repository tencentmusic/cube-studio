...
class SPEECH_PARAFORMER_ASR_NAT_ZH_CN_16K_AISHELL2_VOCAB5212_PYTORCH_Model(Model):
    # 模型基础信息定义
    name='speech-paraformer-asr-nat-zh-cn-16k-aishell2-vocab5212-pytorch'   # 该名称与目录名必须一样，小写
    ...
    hot = "1337"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/speech_paraformer_asr_nat-zh-cn-16k-aishell2-vocab5212-pytorch/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('auto-speech-recognition', 'damo/speech_paraformer_asr_nat-zh-cn-16k-aishell2-vocab5212-pytorch')
...
model=SPEECH_PARAFORMER_ASR_NAT_ZH_CN_16K_AISHELL2_VOCAB5212_PYTORCH_Model()

...
rec_result = inference_pipeline(audio_in='https://isv-data.oss-cn-hangzhou.aliyuncs.com/ics/MaaS/ASR/test_audio/asr_example.wav')
print(rec_result)
```
...
if __name__ == '__main__':
    ...
    params = modelscope_args(model="damo/speech_paraformer_asr_nat-zh-cn-16k-aishell2-vocab5212-pytorch", data_path="./data")
...
```sh
cd egs_modelscope/paraformer/speech_paraformer_asr_nat-zh-cn-16k-aishell2-vocab5212-pytorch
python finetune.py
```

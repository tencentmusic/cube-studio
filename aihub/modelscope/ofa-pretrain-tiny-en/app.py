...
class OFA_PRETRAIN_TINY_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-pretrain-tiny-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "421"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_pretrain_tiny_en/summary"
...
model=OFA_PRETRAIN_TINY_EN_Model()

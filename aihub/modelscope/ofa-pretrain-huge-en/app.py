...
class OFA_PRETRAIN_HUGE_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-pretrain-huge-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "129"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_pretrain_huge_en/summary"
...
model=OFA_PRETRAIN_HUGE_EN_Model()

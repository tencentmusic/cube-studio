...
class CV_UNET_UNIVERSAL_MATTING_Model(Model):
    # 模型基础信息定义
    name='cv-unet-universal-matting'   # 该名称与目录名必须一样，小写
    label='BSHM通用抠图'
    describe=""
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('universal-matting', 'damo/cv_unet_universal-matting')
...
model=CV_UNET_UNIVERSAL_MATTING_Model()

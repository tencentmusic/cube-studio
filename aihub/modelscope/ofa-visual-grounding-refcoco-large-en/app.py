...
class OFA_VISUAL_GROUNDING_REFCOCO_LARGE_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-visual-grounding-refcoco-large-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "11315"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_visual-grounding_refcoco_large_en/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('visual-grounding', 'damo/ofa_visual-grounding_refcoco_large_en')
...
model=OFA_VISUAL_GROUNDING_REFCOCO_LARGE_EN_Model()

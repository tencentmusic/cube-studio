...
class CV_RESNET_FACE_RECOGNITION_FACEMASK_Model(Model):
    # 模型基础信息定义
    name='cv-resnet-face-recognition-facemask'   # 该名称与目录名必须一样，小写
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-recognition', 'damo/cv_resnet_face-recognition_facemask')
...
model=CV_RESNET_FACE_RECOGNITION_FACEMASK_Model()

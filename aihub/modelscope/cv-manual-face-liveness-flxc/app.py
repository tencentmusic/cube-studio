...
class CV_MANUAL_FACE_LIVENESS_FLXC_Model(Model):
    # 模型基础信息定义
    name='cv-manual-face-liveness-flxc'   # 该名称与目录名必须一样，小写
    label='静默人脸活体检测模型-炫彩'
    ...
    hot = "366"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_manual_face-liveness_flxc/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-liveness', 'damo/cv_manual_face-liveness_flxc')
...
model=CV_MANUAL_FACE_LIVENESS_FLXC_Model()

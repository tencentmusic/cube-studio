...
class NLP_CSANMT_TRANSLATION_EN2ZH_Model(Model):
    # 模型基础信息定义
    name='nlp-csanmt-translation-en2zh'   # 该名称与目录名必须一样，小写
    ...
    doc = "https://modelscope.cn/models/damo/nlp_csanmt_translation_en2zh/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('translation', 'damo/nlp_csanmt_translation_en2zh')
...
model=NLP_CSANMT_TRANSLATION_EN2ZH_Model()

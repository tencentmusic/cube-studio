...
class SPEECH_SAMBERT_HIFIGAN_TTS_ZH_CN_16K_Model(Model):
    # 模型基础信息定义
    name='speech-sambert-hifigan-tts-zh-cn-16k'   # 该名称与目录名必须一样，小写
    ...
    hot = "15468"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/speech_sambert-hifigan_tts_zh-cn_16k/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-to-speech', 'damo/speech_sambert-hifigan_tts_zh-cn_16k')

    # web每次用户请求推理，用于对接web界面请求
    @pysnooper.snoop()
    def inference(self,input,video='zhitian_emo',**kwargs):
        result = self.p(input=input, voice=video)
...
model=SPEECH_SAMBERT_HIFIGAN_TTS_ZH_CN_16K_Model()

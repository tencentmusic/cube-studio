...
class OFA_PRETRAIN_BASE_ZH_Model(Model):
    # 模型基础信息定义
    name='ofa-pretrain-base-zh'   # 该名称与目录名必须一样，小写
    ...
    hot = "1140"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_pretrain_base_zh/summary"
...
model=OFA_PRETRAIN_BASE_ZH_Model()

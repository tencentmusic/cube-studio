...
class CV_RESNET50_LIVE_CATEGORY_Model(Model):
    # 模型基础信息定义
    name='cv-resnet50-live-category'   # 该名称与目录名必须一样，小写
    ...
    hot = "316"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_resnet50_live-category/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('live-category', 'damo/cv_resnet50_live-category')
...
model=CV_RESNET50_LIVE_CATEGORY_Model()

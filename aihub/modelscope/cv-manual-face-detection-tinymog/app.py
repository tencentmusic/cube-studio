...
class CV_MANUAL_FACE_DETECTION_TINYMOG_Model(Model):
    # 模型基础信息定义
    name='cv-manual-face-detection-tinymog'   # 该名称与目录名必须一样，小写
    ...
    hot = "2537"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_manual_face-detection_tinymog/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-detection', 'damo/cv_manual_face-detection_tinymog')
...
model=CV_MANUAL_FACE_DETECTION_TINYMOG_Model()

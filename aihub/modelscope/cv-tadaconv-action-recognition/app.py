...
class CV_TADACONV_ACTION_RECOGNITION_Model(Model):
    # 模型基础信息定义
    name='cv-tadaconv-action-recognition'   # 该名称与目录名必须一样，小写
    ...
    web_examples=[
        {
            "label": "示例1",
            "input": {
                "arg0": "/mnt/workspace/.cache/modelscope/damo/cv_TAdaConv_action-recognition/description/video_demo.mp4"
            }
        }
    ]
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('action-recognition', 'damo/cv_TAdaConv_action-recognition')
...
model=CV_TADACONV_ACTION_RECOGNITION_Model()

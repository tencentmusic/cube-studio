...
class CV_RESNET18_LICENSE_PLATE_DETECTION_DAMO_Model(Model):
    # 模型基础信息定义
    name='cv-resnet18-license-plate-detection-damo'   # 该名称与目录名必须一样，小写
    label='读光-车牌检测-通用'
    describe=""
    ...
    hot = "2310"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_resnet18_license-plate-detection_damo/summary"
...
model=CV_RESNET18_LICENSE_PLATE_DETECTION_DAMO_Model()

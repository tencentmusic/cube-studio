...
class SPEECH_SAMBERT_HIFIGAN_TTS_ANNIE_EN_US_16K_Model(Model):
    # 模型基础信息定义
    name='speech-sambert-hifigan-tts-annie-en-us-16k'   # 该名称与目录名必须一样，小写
    ...
    hot = "3105"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/speech_sambert-hifigan_tts_annie_en-us_16k/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-to-speech', 'damo/speech_sambert-hifigan_tts_annie_en-us_16k')
...
model=SPEECH_SAMBERT_HIFIGAN_TTS_ANNIE_EN_US_16K_Model()

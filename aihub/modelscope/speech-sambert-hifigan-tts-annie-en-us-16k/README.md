...
![系统结构](https://modelscope.cn/api/v1/models/damo/speech_sambert-hifigan_tts_annie_en-us_16k/repo?Revision=master&FilePath=description/tts-system.jpg&View=true)
...
![SAMBERT结构](https://modelscope.cn/api/v1/models/damo/speech_sambert-hifigan_tts_annie_en-us_16k/repo?Revision=master&FilePath=description/sambert.jpg&View=true)
...
![系统结构](https://modelscope.cn/api/v1/models/damo/speech_sambert-hifigan_tts_annie_en-us_16k/repo?Revision=master&FilePath=description/hifigan.jpg&View=true)
...
text = '待合成文本'
model_id = 'damo/speech_sambert-hifigan_tts_annie_en-us_16k'

...
class OFA_VISUAL_GROUNDING_REFCOCO_LARGE_ZH_Model(Model):
    # 模型基础信息定义
    name='ofa-visual-grounding-refcoco-large-zh'   # 该名称与目录名必须一样，小写
    ...
    hot = "15613"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_visual-grounding_refcoco_large_zh/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('visual-grounding', 'damo/ofa_visual-grounding_refcoco_large_zh')
...
model=OFA_VISUAL_GROUNDING_REFCOCO_LARGE_ZH_Model()
...
result = model.inference(image='http://xingchen-data.oss-cn-zhangjiakou.aliyuncs.com/maas/visual-grounding/visual_grounding.png',text='一个圆头的蓝色宝可梦')  # 测试
print(result)

...
class NLP_PALM2.0_TEXT_GENERATION_ENGLISH_BASE_Model(Model):
    # 模型基础信息定义
    name='nlp-palm2.0-text-generation-english-base'   # 该名称与目录名必须一样，小写
    ...
    hot = "3716"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/nlp_palm2.0_text-generation_english-base/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-generation', 'damo/nlp_palm2.0_text-generation_english-base')
...
model=NLP_PALM2.0_TEXT_GENERATION_ENGLISH_BASE_Model()
...
result = model.inference(text='The Director of Public Prosecutions who let off Lord Janner over alleged child sex abuse started her career at a legal chambers when the disgraced Labour peer was a top QC there . Alison Saunders , 54 , sparked outrage last week when she decided the 86-year-old should not face astring of charges of paedophilia against nine children because he has dementia . Today , newly-released documents revealed damning evidence that abuse was covered up by police andsocial workers for more than 20 years . And now it has emerged Mrs Saunders ' law career got off to a flying start when she secured her pupillage -- a barrister 's training contract at 1 Garden Court Chambers in London in 1983 .')  # 测试
print(result)

...
class NLP_CSANMT_TRANSLATION_ZH2EN_Model(Model):
    # 模型基础信息定义
    name='nlp-csanmt-translation-zh2en'   # 该名称与目录名必须一样，小写
    ...
    doc = "https://modelscope.cn/models/damo/nlp_csanmt_translation_zh2en/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('translation', 'damo/nlp_csanmt_translation_zh2en')
...
model=NLP_CSANMT_TRANSLATION_ZH2EN_Model()

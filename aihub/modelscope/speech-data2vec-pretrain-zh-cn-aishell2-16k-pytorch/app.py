...
class SPEECH_DATA2VEC_PRETRAIN_ZH_CN_AISHELL2_16K_PYTORCH_Model(Model):
    # 模型基础信息定义
    name='speech-data2vec-pretrain-zh-cn-aishell2-16k-pytorch'   # 该名称与目录名必须一样，小写
    ...
    hot = "773"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/speech_data2vec_pretrain-zh-cn-aishell2-16k-pytorch/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('auto-speech-recognition', 'damo/speech_data2vec_pretrain-zh-cn-aishell2-16k-pytorch')
...
model=SPEECH_DATA2VEC_PRETRAIN_ZH_CN_AISHELL2_16K_PYTORCH_Model()

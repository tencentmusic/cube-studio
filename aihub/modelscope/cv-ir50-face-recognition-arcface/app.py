...
class CV_IR50_FACE_RECOGNITION_ARCFACE_Model(Model):
    # 模型基础信息定义
    name='cv-ir50-face-recognition-arcface'   # 该名称与目录名必须一样，小写
    label='ArcFace人脸识别模型'
    ...
    hot = "885"
    frameworks = ""
    doc = "https://modelscope.cn/models/damo/cv_ir50_face-recognition_arcface/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-recognition', 'damo/cv_ir50_face-recognition_arcface')
...
model=CV_IR50_FACE_RECOGNITION_ARCFACE_Model()

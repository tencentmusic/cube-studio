...
class MPLUG_VISUAL_QUESTION_ANSWERING_COCO_LARGE_EN_Model(Model):
    # 模型基础信息定义
    name='mplug-visual-question-answering-coco-large-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "19064"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/mplug_visual-question-answering_coco_large_en/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('visual-question-answering', 'damo/mplug_visual-question-answering_coco_large_en')
...
model=MPLUG_VISUAL_QUESTION_ANSWERING_COCO_LARGE_EN_Model()

...
class CV_MANUAL_FACE_DETECTION_MTCNN_Model(Model):
    # 模型基础信息定义
    name='cv-manual-face-detection-mtcnn'   # 该名称与目录名必须一样，小写
    ...
    hot = "5033"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_manual_face-detection_mtcnn/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-detection', 'damo/cv_manual_face-detection_mtcnn')
...
model=CV_MANUAL_FACE_DETECTION_MTCNN_Model()

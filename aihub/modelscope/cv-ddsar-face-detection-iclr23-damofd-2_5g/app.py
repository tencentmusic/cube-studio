...
class CV_DDSAR_FACE_DETECTION_ICLR23_DAMOFD_2.5G_Model(Model):
    # 模型基础信息定义
    name='cv-ddsar-face-detection-iclr23-damofd-2.5g'   # 该名称与目录名必须一样，小写
    label='DamoFD人脸检测关键点模型-2.5G'
    ...
    hot = "27"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_ddsar_face-detection_iclr23-damofd-2.5G/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-detection', 'damo/cv_ddsar_face-detection_iclr23-damofd-2.5G')
...
model=CV_DDSAR_FACE_DETECTION_ICLR23_DAMOFD_2.5G_Model()

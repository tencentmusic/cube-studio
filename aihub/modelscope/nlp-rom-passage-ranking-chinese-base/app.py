...
class NLP_ROM_PASSAGE_RANKING_CHINESE_BASE_Model(Model):
    # 模型基础信息定义
    name='nlp-rom-passage-ranking-chinese-base'   # 该名称与目录名必须一样，小写
    ...
    hot = "13416"
    frameworks = ""
    doc = "https://modelscope.cn/models/damo/nlp_rom_passage-ranking_chinese-base/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-ranking', 'damo/nlp_rom_passage-ranking_chinese-base')
...
model=NLP_ROM_PASSAGE_RANKING_CHINESE_BASE_Model()

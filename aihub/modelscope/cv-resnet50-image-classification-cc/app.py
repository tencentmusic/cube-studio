...
class CV_RESNET50_IMAGE_CLASSIFICATION_CC_Model(Model):
    # 模型基础信息定义
    name='cv-resnet50-image-classification-cc'   # 该名称与目录名必须一样，小写
    label='内容审核模型-鉴黄'
    describe=""
    ...
    hot = "139"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_resnet50_image-classification_cc/summary"
...
model=CV_RESNET50_IMAGE_CLASSIFICATION_CC_Model()

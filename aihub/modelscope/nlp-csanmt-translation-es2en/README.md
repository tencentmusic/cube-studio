...
pipeline_ins = pipeline(task=Tasks.translation, model="damo/nlp_csanmt_translation_es2en")
...
trainer = CsanmtTranslationTrainer(model="damo/nlp_csanmt_translation_es2en")
trainer.train()
...
|:---------:|:-----:|:--------------------:|:-----------------------:|:-----------:|
|     -     |   -   |         37.8         |          49.8           |    Google   |
| 24-6-512  | 168M  |         38.4         |          49.3           |  ModelScope |

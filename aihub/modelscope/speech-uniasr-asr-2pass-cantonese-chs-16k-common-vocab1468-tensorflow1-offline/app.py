...
class SPEECH_UNIASR_ASR_2PASS_CANTONESE_CHS_16K_COMMON_VOCAB1468_TENSORFLOW1_OFFLINE_Model(Model):
    # 模型基础信息定义
    name='speech-uniasr-asr-2pass-cantonese-chs-16k-common-vocab1468-tensorflow1-offline'   # 该名称与目录名必须一样，小写
    ...
    doc = "https://modelscope.cn/models/damo/speech_UniASR_asr_2pass-cantonese-CHS-16k-common-vocab1468-tensorflow1-offline/summary"
    ...
    web_examples=[
        {
            "label": "示例1",
            "input": {
                "input": "/mnt/workspace/.cache/modelscope/damo/speech_UniASR_asr_2pass-cantonese-CHS-16k-common-vocab1468-tensorflow1-offline/example/asr_example.wav"
            }
        }
    ]
...
model=SPEECH_UNIASR_ASR_2PASS_CANTONESE_CHS_16K_COMMON_VOCAB1468_TENSORFLOW1_OFFLINE_Model()

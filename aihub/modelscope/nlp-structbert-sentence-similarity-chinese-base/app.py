...
class NLP_STRUCTBERT_SENTENCE_SIMILARITY_CHINESE_BASE_Model(Model):
    # 模型基础信息定义
    name='nlp-structbert-sentence-similarity-chinese-base'   # 该名称与目录名必须一样，小写
    ...
    hot = "7570"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/nlp_structbert_sentence-similarity_chinese-base/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('sentence-similarity', 'damo/nlp_structbert_sentence-similarity_chinese-base')
...
model=NLP_STRUCTBERT_SENTENCE_SIMILARITY_CHINESE_BASE_Model()

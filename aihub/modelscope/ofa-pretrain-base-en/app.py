...
class OFA_PRETRAIN_BASE_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-pretrain-base-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "332"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_pretrain_base_en/summary"
...
model=OFA_PRETRAIN_BASE_EN_Model()

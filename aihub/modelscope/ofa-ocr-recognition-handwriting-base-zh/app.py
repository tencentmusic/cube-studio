...
class OFA_OCR_RECOGNITION_HANDWRITING_BASE_ZH_Model(Model):
    # 模型基础信息定义
    name='ofa-ocr-recognition-handwriting-base-zh'   # 该名称与目录名必须一样，小写
    ...
    hot = "5856"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_ocr-recognition_handwriting_base_zh/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('ocr-recognition', 'damo/ofa_ocr-recognition_handwriting_base_zh')
...
model=OFA_OCR_RECOGNITION_HANDWRITING_BASE_ZH_Model()

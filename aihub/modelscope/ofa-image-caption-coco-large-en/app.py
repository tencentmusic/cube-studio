...
class OFA_IMAGE_CAPTION_COCO_LARGE_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-image-caption-coco-large-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "56253"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_image-caption_coco_large_en/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('image-captioning', 'damo/ofa_image-caption_coco_large_en')
...
model=OFA_IMAGE_CAPTION_COCO_LARGE_EN_Model()

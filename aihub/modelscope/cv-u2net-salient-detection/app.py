...
class CV_U2NET_SALIENT_DETECTION_Model(Model):
    # 模型基础信息定义
    name='cv-u2net-salient-detection'   # 该名称与目录名必须一样，小写
    label='U2Net图像显著性检测'
    ...
    hot = "6863"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_u2net_salient-detection/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('semantic-segmentation', 'damo/cv_u2net_salient-detection')
...
model=CV_U2NET_SALIENT_DETECTION_Model()

...
class NLP_STRUCTBERT_NLI_CHINESE_BASE_Model(Model):
    # 模型基础信息定义
    name='nlp-structbert-nli-chinese-base'   # 该名称与目录名必须一样，小写
    ...
    hot = "1164"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/nlp_structbert_nli_chinese-base/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('nli', 'damo/nlp_structbert_nli_chinese-base')
...
model=NLP_STRUCTBERT_NLI_CHINESE_BASE_Model()

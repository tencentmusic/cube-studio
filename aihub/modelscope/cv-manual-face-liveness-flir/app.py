...
class CV_MANUAL_FACE_LIVENESS_FLIR_Model(Model):
    # 模型基础信息定义
    name='cv-manual-face-liveness-flir'   # 该名称与目录名必须一样，小写
    label='人脸活体检测模型-IR'
    describe=""
    ...
    hot = "237"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_manual_face-liveness_flir/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-liveness', 'damo/cv_manual_face-liveness_flir')
    ...
    def inference(self,arg0,**kwargs):
        ...
        for index,box in enumerate(result['boxes']):
            ...
            cv2.putText(img, 'dummy score:'+str(label), (int(box[0]), int(box[1] - 10)), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
...
model=CV_MANUAL_FACE_LIVENESS_FLIR_Model()

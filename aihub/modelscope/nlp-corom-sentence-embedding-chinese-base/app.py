...
class NLP_COROM_SENTENCE_EMBEDDING_CHINESE_BASE_Model(Model):
    # 模型基础信息定义
    name='nlp-corom-sentence-embedding-chinese-base'   # 该名称与目录名必须一样，小写
    ...
    hot = "10680"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/nlp_corom_sentence-embedding_chinese-base/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('sentence-embedding', 'damo/nlp_corom_sentence-embedding_chinese-base')
...
model=NLP_COROM_SENTENCE_EMBEDDING_CHINESE_BASE_Model()

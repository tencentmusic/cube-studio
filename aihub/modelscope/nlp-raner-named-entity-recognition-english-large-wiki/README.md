...
ner_pipeline = pipeline(Tasks.named_entity_recognition, 'damo/nlp_raner_named-entity-recognition_english-large-wiki')
result = ner_pipeline('Prince Harry meets Maddison Elliott .')
...
model:
  ...
  embedder:
    model_name_or_path: damo/nlp_raner_named-entity-recognition_english-large-wiki
  dropout: 0.1
  use_crf: true
...
### 模型局限性以及可能的偏差
本模型基于从wikidiverse数据集构造的NER数据上训练，在垂类领域英文文本上的NER效果会有降低，请用户自行评测后决定如何使用。

## 训练数据介绍
- [wikidiverse](https://aclanthology.org/2022.acl-long.328/)  wiki领域英文命名实体识别公开数据集，包括应用、书籍、建筑、国家、货币、事件、地址、电影、音乐、组织、其他、人物、景点，共7824个句子。
...
## 数据评估及结果
模型在wikidiverse测试数据评估结果:

| Dataset | Precision | Recall | F1 |
| --- | --- | --- | --- |
| wikidiverse | 76.59 | 75.03 | 75.8 |
...
| APP | 60.0 | 60.0 | 60.0 |
| Book | 0.0 | 0.0 | 0.0 |
| Building | 58.54 | 54.55 | 56.47 |
| Country | 84.97 | 88.02 | 86.47 |
| Currency | 100.0 | 40.0 | 57.14 |
| Event | 71.72 | 58.68 | 64.55 |
| Location | 77.64 | 73.02 | 75.26 |
| Movie | 57.14 | 66.67 | 61.54 |
| Music | 50.0 | 25.0 | 33.33 |
| Organization | 73.28 | 76.92 | 75.06 |
| Other | 67.19 | 64.15 | 65.64 |
| People | 91.02 | 88.59 | 89.79 |
| Site | 43.53 | 56.06 | 49.01 |

...
class CV_RESNEST101_GENERAL_RECOGNITION_Model(Model):
    # 模型基础信息定义
    name='cv-resnest101-general-recognition'   # 该名称与目录名必须一样，小写
    label='万物识别-中文-通用领域'
    ...
    hot = "13963"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_resnest101_general_recognition/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('general-recognition', 'damo/cv_resnest101_general_recognition')
...
model=CV_RESNEST101_GENERAL_RECOGNITION_Model()

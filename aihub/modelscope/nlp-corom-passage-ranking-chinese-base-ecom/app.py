...
class NLP_COROM_PASSAGE_RANKING_CHINESE_BASE_ECOM_Model(Model):
    # 模型基础信息定义
    name='nlp-corom-passage-ranking-chinese-base-ecom'   # 该名称与目录名必须一样，小写
    ...
    hot = "10162"
    frameworks = ""
    doc = "https://modelscope.cn/models/damo/nlp_corom_passage-ranking_chinese-base-ecom/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-ranking', 'damo/nlp_corom_passage-ranking_chinese-base-ecom')
...
model=NLP_COROM_PASSAGE_RANKING_CHINESE_BASE_ECOM_Model()

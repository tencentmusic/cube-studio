...
class CV_CARTOON_STABLE_DIFFUSION_CLIPART_Model(Model):
    ...
    inference_inputs = [
        ...
        Field(type=Field_type.text, name='text', label='输入关键词',describe='可输入人物、物体、场景,如Johnny Depp、猫、supermarket，目前仅支持英文文本提示词输入',default='Johnny Depp',validators=Validator(max=75))

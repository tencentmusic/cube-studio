...
class NLP_COROM_SENTENCE_EMBEDDING_ENGLISH_TINY_Model(Model):
    # 模型基础信息定义
    name='nlp-corom-sentence-embedding-english-tiny'   # 该名称与目录名必须一样，小写
    ...
    hot = "822"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/nlp_corom_sentence-embedding_english-tiny/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('sentence-embedding', 'damo/nlp_corom_sentence-embedding_english-tiny')
...
model=NLP_COROM_SENTENCE_EMBEDDING_ENGLISH_TINY_Model()
...
result = model.inference(arg0='['how long it take to get a master degree']',arg1='['On average, students take about 18 to 24 months to complete a master degree.', 'On the other hand, some students prefer to go at a slower pace and choose to take', 'several years to complete their studies.', 'It can take anywhere from two semesters.']')  # 测试
print(result)

...
class OFA_PRETRAIN_LARGE_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-pretrain-large-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "141"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_pretrain_large_en/summary"
...
model=OFA_PRETRAIN_LARGE_EN_Model()

...
class MGEO_BACKBONE_CHINESE_BASE_Model(Model):
    # 模型基础信息定义
    name='mgeo-backbone-chinese-base'   # 该名称与目录名必须一样，小写
    ...
    hot = "479"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/mgeo_backbone_chinese_base/summary"
...
model=MGEO_BACKBONE_CHINESE_BASE_Model()

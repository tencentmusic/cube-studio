...
class CV_NAFNET_IMAGE_DENOISE_SIDD_Model(Model):
    # 模型基础信息定义
    name='cv-nafnet-image-denoise-sidd'   # 该名称与目录名必须一样，小写
    label='NAFNet图像去噪'
    ...
    web_examples=[
        {
            "label": "示例1",
            "input": {
                "arg0": "/mnt/workspace/.cache/modelscope/damo/cv_nafnet_image-denoise_sidd/data/noisy-demo-0.png"
            }
        },
        {
            "label": "示例2",
            "input": {
                "arg0": "/mnt/workspace/.cache/modelscope/damo/cv_nafnet_image-denoise_sidd/data/noisy-demo-1.png"
            }
        }
    ]
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('image-denoising', 'damo/cv_nafnet_image-denoise_sidd')
...
model=CV_NAFNET_IMAGE_DENOISE_SIDD_Model()

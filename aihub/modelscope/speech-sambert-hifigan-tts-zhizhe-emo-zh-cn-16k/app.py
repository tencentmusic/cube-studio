...
class SPEECH_SAMBERT_HIFIGAN_TTS_ZHIZHE_EMO_ZH_CN_16K_Model(Model):
    # 模型基础信息定义
    name='speech-sambert-hifigan-tts-zhizhe-emo-zh-cn-16k'   # 该名称与目录名必须一样，小写
    ...
    hot = "6719"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/speech_sambert-hifigan_tts_zhizhe_emo_zh-cn_16k/summary"
...
model=SPEECH_SAMBERT_HIFIGAN_TTS_ZHIZHE_EMO_ZH_CN_16K_Model()
...
# 模型大小 900M
# 模型运行速度  v100 gpu  占用1.5G 显存, 示例输入，耗时0.5s
...
result = ner_pipeline('她对有这五项爱好人的深恶痛绝，给我留下难以磨灭的印象。')
...
model:
  ...
  embedder:
    model_name_or_path: damo/nlp_raner_named-entity-recognition_chinese-base-literature
  dropout: 0.1
  use_crf: true
...
### 模型局限性以及可能的偏差
本模型基于literature数据集上训练，在垂类领域中文文本上的NER效果会有降低，请用户自行评测后决定如何使用。

## 训练数据介绍
- [literature](https://github.com/lancopku/Chinese-Literature-NER-RE-Dataset) 文学领域中文命名实体识别公开数据集，包括7种实体，共28897个句子。
...
| --- | --- | --- | --- |
| literature | 79.6 | 71.07 | 75.1 |

各个类型的性能如下: 
| Dataset | Precision | Recall | F1 |
| --- | --- | --- | --- |
| Abstract | 72.22 | 58.04 | 64.36 |
| Location | 65.73 | 65.06 | 65.39 |
| Metric | 75.82 | 29.7 | 42.68 |
| Organization | 61.57 | 40.67 | 48.99 |
| Person | 89.18 | 90.28 | 89.73 |
| Thing | 79.65 | 67.65 | 73.16 |
| Time | 77.72 | 57.86 | 66.34 |

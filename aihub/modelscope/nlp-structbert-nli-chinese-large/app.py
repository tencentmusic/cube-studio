...
class NLP_STRUCTBERT_NLI_CHINESE_LARGE_Model(Model):
    # 模型基础信息定义
    name='nlp-structbert-nli-chinese-large'   # 该名称与目录名必须一样，小写
    ...
    hot = "919"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/nlp_structbert_nli_chinese-large/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('nli', 'damo/nlp_structbert_nli_chinese-large')
...
model=NLP_STRUCTBERT_NLI_CHINESE_LARGE_Model()
...
result = model.inference(arg0='这件衣服挺好看',arg1='这件衣服不好看')  # 测试
print(result)

...
class CV_R2P1D_VIDEO_EMBEDDING_Model(Model):
    # 模型基础信息定义
    name='cv-r2p1d-video-embedding'   # 该名称与目录名必须一样，小写
    label='CMD视频表征模型'
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('video-embedding', 'damo/cv_r2p1d_video_embedding')
...
model=CV_R2P1D_VIDEO_EMBEDDING_Model()

...
class CV_DDSAR_FACE_DETECTION_ICLR23_DAMOFD_10G_Model(Model):
    # 模型基础信息定义
    name='cv-ddsar-face-detection-iclr23-damofd-10g'   # 该名称与目录名必须一样，小写
    label='DamoFD人脸检测关键点模型-10G'
    ...
    hot = "17"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_ddsar_face-detection_iclr23-damofd-10G/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-detection', 'damo/cv_ddsar_face-detection_iclr23-damofd-10G')
...
model=CV_DDSAR_FACE_DETECTION_ICLR23_DAMOFD_10G_Model()

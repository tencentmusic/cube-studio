...
class OFA_SUMMARIZATION_GIGAWORD_LARGE_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-summarization-gigaword-large-en'   # 该名称与目录名必须一样，小写
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-summarization', 'damo/ofa_summarization_gigaword_large_en')
...
model=OFA_SUMMARIZATION_GIGAWORD_LARGE_EN_Model()

...
class NLP_PLUG_TEXT_GENERATION_27B_Model(Model):
    # 模型基础信息定义
    name='nlp-plug-text-generation-27b'   # 该名称与目录名必须一样，小写
    ...
    hot = "7595"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/nlp_plug_text-generation_27B/summary"
...
model=NLP_PLUG_TEXT_GENERATION_27B_Model()

...
class CV_MANUAL_FACE_LIVENESS_FLRGB_Model(Model):
    # 模型基础信息定义
    name='cv-manual-face-liveness-flrgb'   # 该名称与目录名必须一样，小写
    label='人脸活体检测模型-RGB'
    describe=""
    ...
    hot = "264"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_manual_face-liveness_flrgb/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-liveness', 'damo/cv_manual_face-liveness_flrgb')
...
model=CV_MANUAL_FACE_LIVENESS_FLRGB_Model()

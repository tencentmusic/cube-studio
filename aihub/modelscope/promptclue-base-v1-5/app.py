...
class PROMPTCLUE_BASE_V1_5_Model(Model):
    # 模型基础信息定义
    name='promptclue-base-v1-5'   # 该名称与目录名必须一样，小写
    ...
    hot = "13630"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/ClueAI/PromptCLUE-base-v1-5/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text2text-generation', 'ClueAI/PromptCLUE-base-v1-5')
...
model=PROMPTCLUE_BASE_V1_5_Model()

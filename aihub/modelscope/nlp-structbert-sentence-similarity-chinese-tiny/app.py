...
class NLP_STRUCTBERT_SENTENCE_SIMILARITY_CHINESE_TINY_Model(Model):
    # 模型基础信息定义
    name='nlp-structbert-sentence-similarity-chinese-tiny'   # 该名称与目录名必须一样，小写
    ...
    hot = "2130"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/nlp_structbert_sentence-similarity_chinese-tiny/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('sentence-similarity', 'damo/nlp_structbert_sentence-similarity_chinese-tiny')
...
model=NLP_STRUCTBERT_SENTENCE_SIMILARITY_CHINESE_TINY_Model()

...
class OFA_VISUAL_QUESTION_ANSWERING_PRETRAIN_HUGE_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-visual-question-answering-pretrain-huge-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "5074"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_visual-question-answering_pretrain_huge_en/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('visual-question-answering', 'damo/ofa_visual-question-answering_pretrain_huge_en')
...
model=OFA_VISUAL_QUESTION_ANSWERING_PRETRAIN_HUGE_EN_Model()

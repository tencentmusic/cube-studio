    ...
    web_examples=[
        {
            "label": "示例0",
            "input": {
                "image": "/mnt/workspace/.cache/modelscope/damo/cv_vit_object-detection_coco/resources/test_object_0.jpg"
            }
        },
        {
            "label": "示例1",
            "input": {
                "image": "/mnt/workspace/.cache/modelscope/damo/cv_vit_object-detection_coco/resources/test_object_1.jpg"
            }
        },
        {
            "label": "示例2",
            "input": {
                "image": "/mnt/workspace/.cache/modelscope/damo/cv_vit_object-detection_coco/resources/test_object_2.jpg"
            }
        }
    ]
...
result = model.inference(image='/mnt/workspace/.cache/modelscope/damo/cv_vit_object-detection_coco/resources/test_object_0.jpg')  # 测试
print(result)

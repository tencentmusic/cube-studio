...
class CV_CARTOON_STABLE_DIFFUSION_FLAT_Model(Model):
    # 模型基础信息定义
    name='cv-cartoon-stable-diffusion-flat'   # 该名称与目录名必须一样，小写
    label='卡通系列文生图模型-扁平风'
    describe=""
    field="机器视觉"
    scenes=""
    ...
    hot = "93"
    frameworks = "PyTorch"
    doc = "https://modelscope.cn/models/damo/cv_cartoon_stable_diffusion_flat/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-to-image-synthesis', 'damo/cv_cartoon_stable_diffusion_flat')
...
model=CV_CARTOON_STABLE_DIFFUSION_FLAT_Model()

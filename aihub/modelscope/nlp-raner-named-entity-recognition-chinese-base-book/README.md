...
ner_pipeline = pipeline(Tasks.named_entity_recognition, 'damo/nlp_raner_named-entity-recognition_chinese-base-book')
result = ner_pipeline('风族最强大的存在，风帝，为当世顶尖强者之一。')
...
### 模型局限性以及可能的偏差
本模型基于book数据集上训练，在垂类领域中文文本上的NER效果会有降低，请用户自行评测后决定如何使用。

## 训练数据介绍
- [BOOK](https://aclanthology.org/2020.emnlp-main.518.pdf) 小说领域中文命名实体识别公开数据集，包括招式名、地名、组织名、人名、头衔、武器名，共11777个句子。
...
| --- | --- | --- | --- |
| book | 83.46 | 80.52 | 81.96 |

各个类型的性能如下: 
| Dataset | Precision | Recall | F1 |
| --- | --- | --- | --- |
| KUN | 68.29 | 71.01 | 69.62 |
| LOC | 67.7 | 67.27 | 67.48 |
| ORG | 65.93 | 64.59 | 65.26 |
| PER | 93.34 | 92.81 | 93.07 |
| TIT | 79.16 | 78.3 | 78.73 |
| WEA | 78.32 | 56.33 | 65.53 |

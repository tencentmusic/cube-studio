...
- UniASR葡萄牙语语音识别模型，可对近场、低噪、正常语速、朗读形式的葡萄牙语音频进行语音识别：
...
rec_result = inference_pipeline(audio_in='https://isv-data.oss-cn-hangzhou.aliyuncs.com/ics/MaaS/ASR/test_audio/asr_example_pt.wav', param_dict={"decoding_model":"offline"})
print(rec_result)
```
...
```sh
cd egs_modelscope/asr/uniasr/speech_UniASR_asr_2pass-pt-16k-common-vocab1617-tensorflow1-offline/
python infer.py
```

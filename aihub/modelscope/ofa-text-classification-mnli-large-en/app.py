...
class OFA_TEXT_CLASSIFICATION_MNLI_LARGE_EN_Model(Model):
    # 模型基础信息定义
    name='ofa-text-classification-mnli-large-en'   # 该名称与目录名必须一样，小写
    ...
    hot = "466"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/ofa_text-classification_mnli_large_en/summary"
    ...
    inference_inputs = [
        Field(type=Field_type.text, name='text', label='语句A',describe='语句A',default='',validators=Validator(max=512)),
        Field(type=Field_type.text, name='text2', label='语句B',describe='语句B',default='',validators=Validator(max=512))
    ]
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('text-classification', 'damo/ofa_text-classification_mnli_large_en')
...
model=OFA_TEXT_CLASSIFICATION_MNLI_LARGE_EN_Model()

...
class CV_TINYNAS_OBJECT_DETECTION_DAMOYOLO_T_Model(Model):
    # 模型基础信息定义
    name='cv-tinynas-object-detection-damoyolo-t'   # 该名称与目录名必须一样，小写
    ...
    hot = "3366"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_tinynas_object-detection_damoyolo-t/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('image-object-detection', 'damo/cv_tinynas_object-detection_damoyolo-t')
...
model=CV_TINYNAS_OBJECT_DETECTION_DAMOYOLO_T_Model()

...
class CV_RESNET50_PRODUCT_BAG_EMBEDDING_MODELS_Model(Model):
    # 模型基础信息定义
    name='cv-resnet50-product-bag-embedding-models'   # 该名称与目录名必须一样，小写
    label='商品图像同款特征'
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('product-retrieval-embedding', 'damo/cv_resnet50_product-bag-embedding-models')
...
model=CV_RESNET50_PRODUCT_BAG_EMBEDDING_MODELS_Model()

...
class SPEECH_UNIASR_ASR_2PASS_ZH_CN_8K_COMMON_VOCAB3445_PYTORCH_ONLINE_Model(Model):
    # 模型基础信息定义
    name='speech-uniasr-asr-2pass-zh-cn-8k-common-vocab3445-pytorch-online'   # 该名称与目录名必须一样，小写
    ...
    hot = "3276"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/speech_UniASR_asr_2pass-zh-cn-8k-common-vocab3445-pytorch-online/summary"
    ...
    web_examples=[
        {
            "label": "示例1",
            "input": {
                "input": "/mnt/workspace/.cache/modelscope/damo/speech_UniASR_asr_2pass-zh-cn-8k-common-vocab3445-pytorch-online/example/asr_example.wav"
            }
        }
    ]
...
model=SPEECH_UNIASR_ASR_2PASS_ZH_CN_8K_COMMON_VOCAB3445_PYTORCH_ONLINE_Model()

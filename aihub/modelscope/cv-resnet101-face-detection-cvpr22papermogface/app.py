...
import numpy,time,random,pandas,cv2
import pysnooper
import os

class CV_RESNET101_FACE_DETECTION_CVPR22PAPERMOGFACE_Model(Model):
    # 模型基础信息定义
    name='cv-resnet101-face-detection-cvpr22papermogface'   # 该名称与目录名必须一样，小写
    ...
    hot = "6086"
    frameworks = "pytorch"
    doc = "https://modelscope.cn/models/damo/cv_resnet101_face-detection_cvpr22papermogface/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('face-detection', 'damo/cv_resnet101_face-detection_cvpr22papermogface')
...
model=CV_RESNET101_FACE_DETECTION_CVPR22PAPERMOGFACE_Model()

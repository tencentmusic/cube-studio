...
[//]: # (  - Paraformer-large模型上线，多个公开数据集上取得SOTA效果，欢迎试用。)

[//]: # (    - 支持基于MaaSlib推理)

[//]: # (  - [FunASR框架开源]&#40;https://github.com/alibaba-damo-academy/FunASR&#41;，欢迎试用)

[//]: # (    - 支持Paraformer-large模型ModelScope下载。)

[//]: # (    - 支持Paraformer-large模型在AISHELL-1、AISHELL-2数据集上微调并推理。)

[//]: # (    - 支持Paraformer-large模型在AISHELL-1、AISHELL-2、WenetSpeech、SpeechIO TIOBE 推理。)

[//]: # (    - 支持Paraformer-large模型使用私有数据进行微调并推理。)
...
```sh
cd egs_modelscope/asr/paraformerbert/speech_paraformerbert_asr_nat-zh-cn-16k-aishell1-vocab4234-pytorch
python infer.py
```
...
|:-----------------------:|:---------------:|:----------------:|:--------:|
|       ParaformerBert        |      4.30       |      4.80      |  0.0168  |

...
## MMSpeech是什么
**MMSpeech(Multi-Modal Multi-Task Speech-Recognition)**是达摩院自研，于**2022年12月份新鲜出炉**的语音预训练模型，基于[OFA架构](https://modelscope.cn/docs/OFA%20Tutorial) ，能够充分利用无标注文本，显著的降低了字错误率，对比HuBert和Wav2Vec等知名模型的中文版本，在标准benchmark AIShell1的验证集/测试集上的字错误率降低了**48.3%/42.4%**，效果达到 **1.6%/1.9%**，远超SOTA 3.1%/3.3%。

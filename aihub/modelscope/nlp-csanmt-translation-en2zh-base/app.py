...
class NLP_CSANMT_TRANSLATION_EN2ZH_BASE_Model(Model):
    # 模型基础信息定义
    name='nlp-csanmt-translation-en2zh-base'   # 该名称与目录名必须一样，小写
    ...
    doc = "https://modelscope.cn/models/damo/nlp_csanmt_translation_en2zh_base/summary"
    ...
    def load_model(self,save_model_dir=None,**kwargs):
        ...
        self.p = pipeline('translation', 'damo/nlp_csanmt_translation_en2zh_base')
...
model=NLP_CSANMT_TRANSLATION_EN2ZH_BASE_Model()
...
result = model.inference(text='Alibaba Group's mission is to let the world have no difficult business')  # 测试
print(result)

...
![系统结构](https://modelscope.cn/api/v1/models/damo/speech_sambert-hifigan_tts_zhitian_emo_zh-cn_16k/repo?Revision=master&FilePath=description/tts-system.jpg&View=true)
...
![SAMBERT结构](https://modelscope.cn/api/v1/models/damo/speech_sambert-hifigan_tts_zhitian_emo_zh-cn_16k/repo?Revision=master&FilePath=description/sambert.jpg&View=true)
...
![系统结构](https://modelscope.cn/api/v1/models/damo/speech_sambert-hifigan_tts_zhitian_emo_zh-cn_16k/repo?Revision=master&FilePath=description/hifigan.jpg&View=true)
...
#### 多情感标签
使用SSML的emotion标签即可添加多情感，zhitian_emo支持如下情感：neutral，happy，angry，sad，fear，hate，surprise

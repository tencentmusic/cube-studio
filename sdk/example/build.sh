...
docker build -t ccr.ccs.tencentyun.com/cube-studio/aihub:detr-resnet-50-panoptic ./detr-resnet-50-panoptic/ && docker push ccr.ccs.tencentyun.com/cube-studio/aihub:detr-resnet-50-panoptic &

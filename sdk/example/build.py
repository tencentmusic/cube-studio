...
print('docker build -t ccr.ccs.tencentyun.com/cube-studio/aihub:base-cuda11.8  -f Dockerfile-cuda11.8 .')
print('docker push ccr.ccs.tencentyun.com/cube-studio/aihub:base-cuda11.8')

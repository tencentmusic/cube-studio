    ...
    for app_name in dir_list:
        if 'app1' not in app_name:
            ...
            if os.path.exists(dockerfile_path):
                command = "cd %s && docker build -t ccr.ccs.tencentyun.com/cube-studio/aihub:%s . && docker push ccr.ccs.tencentyun.com/cube-studio/aihub:%s"%(app_name,app_name,app_name)
                print(command)

...
class APP1_Model(Model):
    ...
    inference_inputs = [
        ...
        Field(type=Field_type.text_select, name='arg4', label='推理函数的输入参数arg6',
              describe='arg6的详细说明，用于在界面展示,单选组件',choices=['choice1','choice2','choice3'],
              default='choice2',validators=Validator(max=1)),
        Field(type=Field_type.image_select, name='arg5', label='推理函数的输入参数arg7',
              describe='arg7的详细说明，用于在界面展示,单选组件', choices=['风格1.jpg', '风格2.jpg'],
              default='风格2.jpg',validators=Validator(max=1)),
        Field(type=Field_type.text_select, name='arg6', label='推理函数的输入参数arg8',
              describe='arg8的详细说明，用于在界面展示,多选组件，最多可选3个', choices=['choice1', 'choice2', 'choice3'],
              default=['choice1'],validators=Validator(max=3)),
        Field(type=Field_type.image_select, name='arg7', label='推理函数的输入参数arg9',
              describe='arg9的详细说明，用于在界面展示,多选组件，最多可选2张', choices=['风格1.jpg', '风格2.jpg'],

        ...
        "templte_common_ui_config": {
            __("任务元数据"): {
                ...
                "selfDepend": {
                    ...
                    "label": __("自依赖判断"),
                    "require": 1,
                    "choice":[__(x) for x in ["自依赖", '单实例运行', '多实例运行']],
                    "range": "",
                    "default": __("单实例运行"),
                    "placeholder": "",
                    ...
                    "templte_ui_config": {
                        __("参数"): {
                            "etl_task_id": {
                                "type": "str",
                                "item_type": "str",
                                "label": __("已存在任务的task id"),
                                "require": 1,
                                "choice": [],
                                "range": "",
                                "default": "",
                                "placeholder": "",
                                "describe": __("已存在任务的task id"),
                                "editable": 1
                            }
                        }
                    },
...
'''),
    ...
    def pipeline_run_button(self):
        return [
            {
                "name": __("提交"),
                "action_url": "/etl_pipeline_modelview/api/submit_etl_pipeline/%s" % self.pipeline.id,

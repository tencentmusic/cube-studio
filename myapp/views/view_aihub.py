        ...
        try:
            if aihub and aihub.job_template:
                ...
                args = {
                    ...
                    "job_template_volume":"/data/k8s/kubeflow/global/cube-studio/aihub/src(hostpath):/src,/data/k8s/kubeflow/global/cube-studio/aihub/deep-learning/{aihub.name}(hostpath):/app",
                    ...
                    tasks=[
                        {
                            ...
                            "command":"/src/docker/entrypoint.sh python app train",
                            "args":args,
                            "volume_mount":f"kubeflow-user-workspace(pvc):/mnt,/data/k8s/kubeflow/global/cube-studio/aihub/src(hostpath):/src,/data/k8s/kubeflow/global/cube-studio/aihub/deep-learning/{aihub.name}(hostpath):/app",

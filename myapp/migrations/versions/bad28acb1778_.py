...
Revision ID: bad28acb1778
Revises: aa2d53864721
Create Date: 2023-02-10 23:39:30.690289
...
def upgrade():
    ...
    sa.Column('gaia_id', sa.String(length=100), nullable=False),
    sa.Column('task_id', sa.String(length=100), nullable=False),
    sa.Column('spark_log_url', sa.String(length=400), nullable=False),
    sa.Column('spark_ui_url', sa.String(length=400), nullable=False),
    ...
    sa.Column('rtx', sa.String(length=400), nullable=False),
    sa.Column('biz', sa.String(length=400), nullable=False),
    ...
    op.add_column('dataset', sa.Column('segment', sa.String(length=200), nullable=True))

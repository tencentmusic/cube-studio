...
docker build -t $hubhost/notebook:jupyter-ubuntu20.04 --build-arg FROM_IMAGES=$base_image --build-arg PYTHONVERSION=3.8 --build-arg CONDAENV=python38 -f Dockerfile-ubuntu-conda .
docker push $hubhost/notebook:jupyter-ubuntu20.04
...
docker build -t $hubhost/notebook:jupyter-ubuntu20.04-cuda11.4.0-cudnn8 --build-arg FROM_IMAGES=$base_image --build-arg PYTHONVERSION=3.8 --build-arg CONDAENV=python38 -f Dockerfile-ubuntu-conda .

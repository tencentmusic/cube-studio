...
from job.pkgs.context import JobComponentRunner, JobComponentEntry
from job.pkgs.utils import recur_expand_param
from job.tf_distributed_evaluation.tfjob_launcher import TFJobLauncher as EvalTFJobLauncher
from job.tf_distributed_train.tfjob_launcher import TFJobLauncher as TrainTFJobLauncher
...
class ModelTemplateDriver(JobComponentRunner):
    ...
    def _eval_proc(self, jc_entry: JobComponentEntry, train_output_file: str):
        job_detail = jc_entry.job['job_detail']
        eval_args = job_detail.get('eval_args', job_detail.get('evaluation_args'))

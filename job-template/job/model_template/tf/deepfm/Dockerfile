...
RUN pip3 install nni tensorflow==2.3.0 tensorboard-plugin-profile==2.3.0 tensorflow-addons pandas sklearn scipy==1.4.1 prettytable -i https://mirrors.tencent.com/pypi/simple

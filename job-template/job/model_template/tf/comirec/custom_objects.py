...
from job.model_template.tf.comirec.model import ComiRecModel


class SampledSoftmaxLoss(tf.keras.losses.Loss, ABC):
    def __init__(self, model: ComiRecModel, num_samples, num_classes, sample_algo=None,
...
class TopKHitrate(SparseTopKInterestsMCategoricalAccuracy):
    ...
    """
    def __init__(self, model: ComiRecModel, num_classes, k, name="topk_hitrate", m=None, dtype=None):
...
custom_objects = {
    ...
    'PoolingProcessLayer': PoolingProcessLayer,
    'DNNLayer': DNNLayer,

...
from tensorflow.python.keras.engine.compile_utils import MetricsContainer, match_dtype_and_rank, apply_mask
try:
    from tensorflow.python.keras.engine.compile_utils import get_mask
except:
    def get_mask(*args):
        raise RuntimeError("get_mask not implemented or deprecated")

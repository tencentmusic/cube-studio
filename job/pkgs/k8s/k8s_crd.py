        ...
        if name:
            ...
            for crd in crds:
                ...
                for k, v in labels.items():
                    if k not in crd_labels or crd_labels[k] != v:
                        matched = False
                        break
                if not matched:
                    continue
                try:
                    ...
                    print("deleted k8s resource '{}/{}/{}' with lables {} in namespace '{}'"
                          .format(self.group, self.version, self.plural, labels, namespace))
                except Exception as e:
                    print("deleted k8s resource '{}/{}/{}' with lables {} in namespace '{}' error: {}\n{}"
                          .format(self.group, self.version, self.plural, labels, namespace, e,

...
LastEditTime: 2021-08-25 17:32:08
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /job-template/job/model_template/tf/deepfm/template.py
'''
# coding=utf-8
# @Time     : 2021/2/8 20:24
...
def awf_input_placeholders_fn(model_input_config_file, model: DeepFMModel):
    return model.get_input_placeholders()

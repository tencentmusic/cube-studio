...
if __name__ == '__main__':
    ...
    # ds = TFRecordDataParser('deepfm/model_input_demo_minister.json', 'deepfm/tfrecord_config.json')\
    #     .create_dataset_from_file('D:/work/docs/data/deepfm/part-r-0000[0-2].gz', 8, 'GZIP', repeat=True,
    #                               drop_remainder=True)
    # for r in ds:
    #     print(r)
    ds = CSVDataParser('deepfm/model_input_demo.json')\
        .create_dataset_from_file('D:/work/docs/data/deepfm/test-part*.csv', ' ', 8, drop_remainder=True, repeat=True)
    ...
    ds = ds.with_options(options).prefetch(buffer_size=tf.data.experimental.AUTOTUNE)
    dist_ds = train_ds = strategy.experimental_distribute_dataset(ds)
